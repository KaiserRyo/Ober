...
{
	cacheLocation = QDesktopServices::storageLocation(QDesktopServices::CacheLocation) + "/imagecache";
...
const QString& WebImageView::imageID() const
{
	return mImageID;
}

void WebImageView::setImageID(const QString imageID)
{
	mImageID = imageID;
